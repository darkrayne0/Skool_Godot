...
@onready var drawer_r: MeshInstance3D = $".."

@export var animation_player: AnimationPlayer


func interact():
		#if door.is_in_group("locked_door"):  #todo - locked drawers
	...
	if interactable:
		...
		toggle = !toggle
		if toggle:
			animation_player.play("open_r_drawer")
		else:
			animation_player.play_backwards("open_r_drawer")
